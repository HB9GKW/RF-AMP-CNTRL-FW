...
void lcd_putchar(unsigned char lcddata) {
...
bool lcd_putcharlc(uint8_t line, uint8_t col, unsigned char value) {
...
bool lcd_printlc(uint8_t line, uint8_t col, unsigned char *string) {
...
bool lcd_printlcc(uint8_t line, uint8_t col, unsigned char *string) {    
